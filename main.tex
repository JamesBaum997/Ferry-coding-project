...
\title{Ferry Coding Project}
\author{James Baum, Oliver Magee and Nichole Bankole }
\affil{
...
Task 3 
Currently we've built a system that separates the vehicles into 5 different groups based on their size. We've ordered them so lorries boarded the ferry first then vans, then large - medium - small cars. This system should be an improvement to the previous system of letting them randomly board as we let the vehicles with the most variance board first. This should minimize overflows and improve wasting the ends of lanes as much. When we ran the input file through the code, we got the overflow was 30 vehicles and the total overflow was 11425 cms.
